...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string>[] = [
    ...
    { stimulus: '<p>Susie’s goldfish will die if she stops feeding it or cleaning its tank–she’s stopped doing both.  Susie’s father only knows that she’s stopped cleaning the goldfish’s tank.</p><p>He tells you: “Susie not cleaning the fish tank will kill her goldfish.”</p>', prompt: 'Do you think Susie’s father would accept the following statement: “If Susie starts cleaning the fish tank, her goldfish won’t die.”'},
    { stimulus: '<p>Susie’s goldfish will die if she stops feeding it or cleaning its tank–she’s stopped doing both.  Susie’s father knows that she hasn’t been feeding her goldfish or cleaning its tank.</p><p>He tells you: “Susie not cleaning the fish tank will kill her goldfish.”</p>', prompt: 'Do you think Susie’s father would accept the following statement: “If Susie starts cleaning the fish tank, her goldfish won’t die.”'},
