...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string>[] = [
    ...
    { stimulus: 'There are two ways to get $5 from Mr. Johnson: mowing his lawn or cleaning his gutters. Laura knows that she can obtain $5 by either mowing Mr. Johnson’s lawn or cleaning his gutters. She tells you: “If you mow Mr. Johnson’s lawn, he’ll pay you $5.”', prompt: 'Do you think Laura would accept the following statement: “If you don’t mow Mr. Johnson’s lawn, he won’t pay you $5.”'},
    { stimulus: 'Bob has two risk factors for cardiovascular disease: he smokes and he drinks excessively. However, Bob’s doctor only knows about Bob’s smoking. He tells you: “If Bob doesn’t quit smoking, he’ll get cardiovascular disease.”',  prompt: 'Do you think Bob’s doctor would accept the following statement: “If Bob quits smoking, he won’t get cardiovascular disease.”'},
    ...
    { stimulus: 'There are two ways Susie could kill her goldfish: by not feeding it and by not cleaning its tank. Her father knows that Susie has both stopped doing either. He tells you: “Susie not cleaning the tank killed the goldfish.”', prompt: 'Do you think Susie’s father would accept the following statement: “If Susie had cleaned the fish tank, the goldfish wouldn’t have died.”'},
  ]
