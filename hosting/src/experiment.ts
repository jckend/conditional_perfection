...
export async function runExperiment(updateDebugPanel: () => void): Promise<void> {
  ...
  const test_stimuli: Record<string>[] = [
    ...
    { stimulus: '<p>Bob has two risk factors for cardiovascular disease: he smokes and he drinks excessively. However, Dr. Smith only knows about Bob’s smoking.</p> <p>He tells you: “Bob’s smoking will cause him to get cardiovascular disease.”</p>',  prompt: 'Do you think Dr. Smith would accept the following statement: “If Bob quits smoking, he won’t get cardiovascular disease.”'},
    { stimulus: '<p>Bob has two risk factors for cardiovascular disease: he smokes and he drinks excessively. Dr. Smith knows about both risk factors.</p> <p>He tells you: “Bob’s smoking will cause him to get cardiovascular disease.”</p>',  prompt: 'Do you think Bob’s doctor would accept the following statement: “If Bob quits smoking, he won’t get cardiovascular disease.”'},
